...
import 'package:itinerary_monitoring/src/manager/employee_list.dart';
import 'package:itinerary_monitoring/src/employee/employee_order.dart';
import 'package:itinerary_monitoring/src/manager/employee_marker.dart';
...
class _ManagerScreenState extends State<ManagerScreen> {
  ...
  Future<Marker> generateActualMarker(EmployeeModel item) async {
    final bitmapIcon = await BitmapDescriptor.asset(const ImageConfiguration(size: Size(8, 8)),
